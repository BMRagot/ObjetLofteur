...
public class Lapin extends Neuneu{
	...
	/**
	 * Methode de deplacement du lapin qui ne cherche qu'ˆ courir apr�s un partenaire sexuel
	 * @see Neuneu#seDeplacer()
	 */
	public void seDeplacer(){		
		// si le lapin possede suffisament d'energie pour se reproduire alors il par ˆ la recherche d'un partenaire
		if( this.energie>50 && this.environnement.getPopulation().size()>1){
			//calcul des distance sŽparant les lapins des autres neuneu
			...
			// calcul des dŽplacements necessaires
			if(a[l]>0){
			...
			// si le lapin n'a pas assez d'Žnergie, il se dŽplace de facon aleatoire ˆ l arecherche d'Žnergie
	...
	/**
	 * Affichage graphique
	 * les lapins sont reprŽsentŽs par des points roses
	 * 
	 */
	@Override
